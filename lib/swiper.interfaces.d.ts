...
export declare class fadeObject implements fadeObjectInterface {
    crossFade: boolean;
}
export declare class flipObject implements flipObjectInterface {
    limitRotation: boolean;
    slideShadows: boolean;
}
export declare class cubeObject implements cubeObjectInterface {
    shadow: boolean;
    shadowScale: number;
    shadowOffset: number;
    slideShadows: boolean;
}
export declare class coverflowObject implements coverflowObjectInterface {
    depth: number;
    rotate: number;
    stretch: number;
    modifier: number;
...
export declare class SwiperConfig implements SwiperConfigInterface {
    ...
    assign(config?: SwiperConfigInterface): void;
}
